...
public class Ex02 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        out.println("</head>");
        out.println("<body>");
        out.println("<h0 style='background-color: tomato;'> 제목 태그 h0 </h0>");
        out.println("<h0>제목 태그 h0</h0>");
        out.println("<h1 style='background-color: snow;'> 제목 태그 h1 </h1>");
        ...
        out.println("<hr>");
        out.println("<span style='background-color:lavender;'> HTML & CSS</span>");
